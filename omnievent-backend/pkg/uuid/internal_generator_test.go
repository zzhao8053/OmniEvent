...
func TestGenerateUuid(t *testing.T) {
	...
	generator, _ := NewInternalUuidGenerator(&cmd.Config{Uuid: cmd.UuidConfig{ServerId: expectedUuidServerId}})
...
func TestGenerateUuid_MultiType(t *testing.T) {
	generator, _ := NewInternalUuidGenerator(&cmd.Config{Uuid: cmd.UuidConfig{ServerId: 1}})
...
func TestGenerateUuid_2000TimesIn2Seconds(t *testing.T) {
	generator, _ := NewInternalUuidGenerator(&cmd.Config{Uuid: cmd.UuidConfig{ServerId: 2}})
...
func TestGenerateUuid_10000TimesConcurrent(t *testing.T) {
	concurrentCount := 10
	generator, _ := NewInternalUuidGenerator(&cmd.Config{Uuid: cmd.UuidConfig{ServerId: 3}})
